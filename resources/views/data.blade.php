                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 align-baseline">
                                <x-filter-button sortBy="{{$filter['sortBy']}}" order="{{$filter['order']}}" value="username">
                                    Username
                                </x-filter-button>
                            </th>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 align-baseline">
                                <x-filter-button sortBy="{{$filter['sortBy']}}" order="{{$filter['order']}}" value="meetCount">
                                    Meet count
                                </x-filter-button>
                            </th>
                            ...
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 align-baseline">
                                <x-filter-button sortBy="{{$filter['sortBy']}}" order="{{$filter['order']}}" value="timeMet">
                                    First Meet
                                </x-filter-button>
                            </th>
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 align-baseline">
                                <x-filter-button sortBy="{{$filter['sortBy']}}" order="{{$filter['order']}}" value="updatedAt">
                                    Last Meet
                                </x-filter-button>
                            </th>
                        </tr>
                        ...
                        <tr class="hover:bg-zinc-50">
                            ...
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                <div class="flex flex-col gap-2">
                                    ...
                                    @endforeach
                                    @else
                                    <span class="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-600 ring-1 ring-inset ring-gray-500/10">{{ $gameMode[$filter['mode']] }}</span>
                                    @endif
                                </div>
                            </td>
                            <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="flex gap-2 items-center">
                                        <div class="flex-1 inline-flex items-center gap-1 rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20 relative group">
                                            ...
                                            <div class="opacity-0 absolute -top-8 left-1/2 -translate-x-1/2 pointer-events-none group-hover:opacity-100 transition-opacity duration-150 inline-flex items-center rounded-md bg-zinc-800 px-2 py-1 text-xs font-medium text-white ring-1 ring-inset ring-zinc-800/10">
                                                <p class="text-xs">You have won {{$data['with']['wins']}} game whit this player in {{ $gameMode[$d] }}</p>
                                        ...
                                        <div class="flex-1 inline-flex items-center gap-1 rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 relative group">
                                            ...
                                            <div class="opacity-0 absolute -top-8 left-1/2 -translate-x-1/2 pointer-events-none group-hover:opacity-100 transition-opacity duration-150 inline-flex items-center rounded-md bg-zinc-800 px-2 py-1 text-xs font-medium text-white ring-1 ring-inset ring-zinc-800/10">
                                                <p class="text-xs">You have lost {{$data['with']['losses']}} game whit this player in {{ $gameMode[$d] }}</p>
                                                <span class="absolute left-1/2 -translate-x-1/2 top-3 -z-10 block h-5 w-5 bg-zinc-800 rounded-sm rotate-45"></span>
                                            </div>
                                        </div>
                                ...
                                <div class="flex flex-col gap-2">
                                    ...
                                    <div class="flex gap-2 items-center">
                                        <div class="flex-1 inline-flex items-center gap-1 rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20 relative group">
                                            ...
                                            <div class="opacity-0 absolute -top-8 left-1/2 -translate-x-1/2 pointer-events-none group-hover:opacity-100 transition-opacity duration-150 inline-flex items-center rounded-md bg-zinc-800 px-2 py-1 text-xs font-medium text-white ring-1 ring-inset ring-zinc-800/10">
                                                <p class="text-xs">You have won {{$data['against']['wins']}} game against this player in {{ $gameMode[$d] }}</p>
                                                <span class="absolute left-1/2 -translate-x-1/2 top-3 -z-10 block h-5 w-5 bg-zinc-800 rounded-sm rotate-45"></span>
                                            </div>
                                        </div>
                                        <div class="flex-1 inline-flex items-center gap-1 rounded-md bg-red-50 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10 relative group">
                                            ...
                                            <div class="opacity-0 absolute -top-8 left-1/2 -translate-x-1/2 pointer-events-none group-hover:opacity-100 transition-opacity duration-150 inline-flex items-center rounded-md bg-zinc-800 px-2 py-1 text-xs font-medium text-white ring-1 ring-inset ring-zinc-800/10">
                                                <p class="text-xs">You have lost {{$data['against']['losses']}} game against this player in {{ $gameMode[$d] }}</p>
                                                <span class="absolute left-1/2 -translate-x-1/2 top-3 -z-10 block h-5 w-5 bg-zinc-800 rounded-sm rotate-45"></span>
                                            </div>
                                        </div>
                                        <div class="flex-1 inline-flex items-center gap-1 rounded-md bg-blue-50 px-2 py-1 text-xs font-medium text-blue-700 ring-1 ring-inset ring-blue-700/10">
